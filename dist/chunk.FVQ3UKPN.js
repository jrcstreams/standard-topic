import{A as nt,B as me,C as it,D as be,G as ot,I as ve,h as Qe,j as Ze,k as Ke,q as se,r as qe,s as Te,t as _,u as et,v as tt,w as Pe}from"./chunk.7FTYUKPC.js";var s={step:0,values:{},customValues:{},extraInputs:{},modelId:null,customizations:"",visited:new Set};function ze(){return{values:JSON.parse(JSON.stringify(s.values||{})),customValues:JSON.parse(JSON.stringify(s.customValues||{})),extraInputs:JSON.parse(JSON.stringify(s.extraInputs||{})),customizations:s.customizations||""}}function le(e){e&&(s.values=JSON.parse(JSON.stringify(e.values)),s.customValues=JSON.parse(JSON.stringify(e.customValues)),s.extraInputs=JSON.parse(JSON.stringify(e.extraInputs)),s.customizations=e.customizations)}var G=null,He=null,ut=[],U=null,L=null,ie=[],gt='<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 18 9 12 15 6"/></svg>';function _e(e){ie.push(e),e()}function de(){ie.length>1&&ie.pop();let e=ie[ie.length-1];e&&e()}function Fe({title:e,footer:t=!0,doneLabel:n="Done",onDone:a,onCancel:i}){L.innerHTML=`
