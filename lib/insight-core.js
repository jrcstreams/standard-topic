...
// (one grounded call fires several), free up to GROUNDING_FREE queries/day
// (1,500 on paid Tier 1), then GROUNDING_PER_SEARCH_MICROS each ($35 / 1,000 =
// 35 millionths). We stop issuing grounded calls once the day's search count
// reaches SEARCH_BUDGET — a buffer under the free tier — so grounding stays $0;
// past that, briefs still generate, just ungrounded (also free).
