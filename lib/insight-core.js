...
// needs no SerpAPI round-trip. Sized for the $25 Starter plan (1,000/mo): the 2h
// snapshot cron uses ~360/mo, so a 10/day fallback ceiling (~300/mo worst case)
// leaves ~1/3 headroom even if the RSS primary failed every single time.
const SERP_TREND_DAILY_BUDGET = Number(process.env.SERP_TREND_DAILY_BUDGET || 10);
