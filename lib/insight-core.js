...
function newsPrompt(e, grounded = true, related = []) {
  ...
  return [
    ...
    SPECIFICITY_RULES,
    // revamp1243: Timeline is the ONLY section that needs facts the story does not
    // contain — dated prior events — and it is the section that invents them when
    // it has none. Grounded, it is the most valuable part of the brief. Ungrounded,
    // it is the most dangerous. So it is requested only when we can actually check.
    grounded
