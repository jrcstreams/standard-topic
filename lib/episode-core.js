...
`headline: ONE line, max 12 words, that names the day across its top two or three stories together — "Markets Jolt as Middle East Tensions Rise and AI Fears Hit Tech" — never the lead story alone, and no colon-led label. summary: one or two sentences, max 40 words, saying what happened in the top three stories with their key figures, written for a reader.`,
...
async function runHeadline(script, { model = textModel() } = {}) {
  ...
  const prompt = [
    ...
    '"headline": ONE line, max 12 words, naming the day across its top two or three stories together (e.g. "Markets Jolt as Middle East Tensions Rise and AI Fears Hit Tech") — never the lead alone, no colon-led label, no markdown.',
