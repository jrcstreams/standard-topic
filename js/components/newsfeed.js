...
export function renderNewsFeed(container, topic, isHome) {
  ...
  container.innerHTML = `
    <div class="newsfeed-card">
      <h3 class="newsfeed-title"><svg class="section-head-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8"/><path d="M15 18h-5"/><path d="M10 6h8v4h-8V6Z"/></svg><span class="newsfeed-title-main">News Feed</span>${pillHTML}</h3>
