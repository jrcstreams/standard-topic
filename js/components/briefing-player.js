...
const INFO = '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><line x1="12" y1="11" x2="12" y2="16"/><circle cx="12" cy="8" r="0.6" fill="currentColor"/></svg>';
      ...
      <div class="bp-row">
        <div class="bp-lead">
          ...
          <div class="bp-txt">
            ...
            <div class="bp-meta">${durMin ? `<span>${durMin} min</span><span class="bp-dot" aria-hidden="true">·</span>` : ''}<span>AI-narrated from today’s sourced briefing</span><button type="button" class="bp-info how-aigen" data-how-it-works aria-label="How the audio is made">${INFO}</button></div>
          </div>
        </div>
