...
const ICONS = {
  ...
  'maple-leaf': '<path d="M12 21v-3.2" /> <path d="M12 17.8l-4 .8 1-2.4-3.2-.4 2.4-1.9-1.8-1.8 2.5.5-.6-3 2.7 1.4L12 7l1.6 3.6 2.7-1.4-.6 3 2.5-.5-1.8 1.8 2.4 1.9-3.2.4 1 2.4z" />',
  ...
  'snowflake': '<path d="M12 2v20" /> <path d="M2 12h20" /> <path d="m5 5 14 14" /> <path d="m19 5-14 14" /> <path d="M12 6.5 9.9 8.6M12 6.5l2.1 2.1M12 17.5l-2.1-2.1M12 17.5l2.1-2.1M6.5 12 8.6 9.9M6.5 12l2.1 2.1M17.5 12l-2.1-2.1M17.5 12l-2.1 2.1" />',
