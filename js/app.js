...
import { renderNewsFeed, renderBriefBody, listHTML as newsListHTML, wireNewsAI } from './components/newsfeed.js?v=20260612-revamp173';
import { renderShortcuts } from './components/shortcuts.js';
import { renderRelatedTopics } from './components/related-topics.js';
import { renderPromptGenerator } from './components/prompt-generator.js?v=20260612-revamp173';
import { initPromptBuilderModal, openPromptBuilderModal, closePromptBuilderModal } from './components/prompt-builder-modal.js?v=20260612-revamp173';
import { initPromptModal } from './components/prompt-modal.js?v=20260612-revamp173';
import { renderTrending, renderTrendingTopics, renderTrendingHome } from './components/trending.js?v=20260612-revamp173';
import { fetchTrending } from './utils/trending.js';
import { DEFAULT_GROUP_DEFS, groupShortcuts, renderTIAccordion, webSourceItem, TI_SECTION_META } from './components/ti-shortcuts.js';
import { initTrendingDetailModal } from './components/trending-detail-modal.js?v=20260612-revamp173';
import { initInsightModal } from './components/insight-modal.js?v=20260612-revamp173';
import { renderAIIntelligence } from './components/ai-intelligence.js?v=20260612-revamp173';
import { initAIIntelligenceModal } from './components/ai-intelligence-modal.js?v=20260612-revamp173';
import { renderWebSources } from './components/websources.js?v=20260612-revamp173';
import { initTrendingListModal } from './components/trending-list-modal.js?v=20260612-revamp173';
import { initDiscoverModal } from './components/discover-modal.js';
import { initAllTopicsModal } from './components/all-topics-modal.js?v=20260612-revamp173';
import { initRelatedTopicsModal } from './components/related-topics-modal.js';
import { initPromptPreviewModal } from './components/prompt-preview-modal.js?v=20260612-revamp173';
import { initSettingsModal } from './components/settings-modal.js?v=20260612-revamp173';
    ...
    <div class="sticky-hero-inner">
      ...
      <div class="sticky-actions">
        ...
        <button type="button" class="sticky-topics" id="nav-topics" aria-label="All topics" aria-haspopup="dialog">
          ...
          <span class="sticky-topics-label">Topics</span>
        </button>
      </div>
    </div>
...
function renderTopicLayout(container, { topic, route, isHome, isCustom = false, customTerm = '' }) {
  ...
  if (shortcutsSection) {
    if (topic && !isHome && !isCustom) {
      ...
      const descriptions = {};
      try { (getShortcutsForTopic(topic.slug) || []).forEach((s) => { if (s && s.name) descriptions[s.name] = s.description || ''; }); } catch (_) {}
      renderAIIntelligence(shortcutsSection, { topic: topic.name, label: topic.name, descriptions });
    } else {
